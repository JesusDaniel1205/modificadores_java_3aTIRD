...
public class TestingModificadores {
    public static void main (String[] args) {
        ...
        unHijo.setCampo3(12); //campo privaod propio
        ...
        //objeto1.z = 98; //no se puedeacceder porque no esta en el mismo paquete y es tipo protected
